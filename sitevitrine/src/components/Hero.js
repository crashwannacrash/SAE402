    ...
    <div className="bg-green-700">
      <div className="container mx-auto flex flex-col md:flex-row py-16 md:py-32">
        <div className="md:w-1/2 text-center items-center md:items-start md:text-left flex flex-col gap-4 mt-8">
          ...
          <a href='#' className="bg-white hover:bg-green-900 hover:transition-all transition-all text-gray-800 hover:text-white font-semibold rounded w-max px-8 py-4 mt-8 justify-self-end">Tester le jeu</a>
        </div>
